...
from bin.constant import MISTRAL_MINI
...
load_dotenv()
MODEL_PATH = os.getenv("MISTRAL_MINI_MODEL_NAME")
MODEL_PATH = "ministral/Ministral-3b-instruct"
ASSISTANT_ROLE = os.getenv("ASSISTANT_ROLE")
DEVICE = os.getenv("DEVICE")


@ChatFactory.register(MISTRAL_MINI)
class MistralMiniChat(Chat):
    def __init__(self):
        super().__init__()
